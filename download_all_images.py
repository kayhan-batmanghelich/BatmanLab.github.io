...
# Extract image URLs from index.html
print("Extracting image URLs from index.html...")
with open('index.html', 'r', encoding='utf-8') as f:
    html_content = f.read()

# Find all img src attributes in the publications section
pattern = r'<img src="images/publications/([^"]+)"'
matches = re.findall(pattern, html_content)

print(f"Found {len(matches)} image references in HTML\n")

# Now we need to map these to the actual URLs from the JSON
# Let's read the JSON from the user's original input
# For now, let's create a mapping by reading the HTML and extracting URLs

# Extract URLs from meta-links or we can use a different approach
# Let's create a comprehensive list from the user's JSON

# Full JSON data from user's input
json_data = """{
  "2024": [
    {
  ...
  "2020": [
    {
      ...
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2020/07/Screen-Shot-2020-07-05-at-7.52.22-PM-300x146.png"
    },
    {
  ...
  "2019": [
    {
      ...
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2019/2019_1-300x158.png"
    },
    {
      "title": "Twin Auxiliary Classifiers GAN",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2019/GAN-300x92.png"
    },
    {
      "title": "Generative Interpretability: Application in Disease Subtyping",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2019/2019_3_1_r-1-300x186.png"
    },
    {
      "title": "Robust Ordinal VAE: Employing Noisy Pairwise Comparisons for Disentanglement",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2019/2019_4_1_r-1.png"
    }
  ],
  "2018": [
    {
      "title": "Subject2Vec: Generative-Discriminative Approach from a Set of Image Patches to a Vector",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2018/2018_1_r-300x135.png"
    },
    {
      "title": "A structural equation model for imaging genetics using spatial transcriptomics",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2020/07/Screen-Shot-2020-07-05-at-7.27.30-PM-300x177.png"
    },
    {
      "title": "Causal Generative Domain Adaptation Networks",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2018/2018_3_r_1-300x122.png"
    },
    {
      "title": "Deep Diffeomorphic Normalizing Flows",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2018/2018_4_r_1.png"
    },
    {
      "title": "An Efficient and Provable Approach for Mixture Proportion Estimation Using Linear Independence Assumption",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2018/2018_5_1_r-300x183.png"
    },
    {
      "title": "Deep Ordinal Regression Network for Monocular Depth Estimation",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2018/2018_6_1_R-300x73.png"
    },
    {
      ...
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2018/2018_7_1_r-300x128.png"
    }
  ],
  "2017": [
    {
      "title": "Transformations Based on Continuous Piecewise-Affine Velocity Fields",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2017/2017_1_1_r.png"
    },
    {
      "title": "A Likelihood-Free Approach for Characterizing Heterogeneous Diseases in Large-Scale Studies",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2017/2017_2_1_r-300x103.png"
    }
  ],
  "2016": [
    {
      "title": "Unsupervised Discovery of Emphysema Subtypes in a Large Clinical Cohort",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2016/2016_1_1_r-300x133.png"
    },
    {
      "title": "Probabilistic Modeling of Imaging, Genetics and the Diagnosis",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2016/2016_2_1_r-300x136.png"
    },
    {
      "title": "Nonparametric Spherical Topic Modeling with Word Embeddings",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2016/2016_3_1_r.png"
    },
    {
      "title": "Inferring Disease Status by non-Parametric Probabilistic Embedding",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2016/2016_4_1_r-300x164.png"
    }
  ],
  "2015": [
    {
      "title": "Highly-Expressive Spaces of Well-Behaved Transformations: Keeping It Simple",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2015/2015_1_1_r.png"
    },
    {
      "title": "Generative Method to Discover Genetically Driven Image Biomarkers",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2015/2015_2_1_r-300x237.png"
    }
  ],
  "2014": [
    {
      "title": "Spherical Topic Models for Imaging Phenotype Discovery in Genetic Studies",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2014/2014_1_1_r.png"
    },
    {
      "title": "Diversifying Sparsity Using Variational Determinantal Point Processes",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2014/2014_2_1_r-300x131.png"
    },
    {
      "title": "BrainPrint in the Computer-Aided Diagnosis of Alzheimer's Disease",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2014/2014_5_1_r-300x204.png"
    }
  ],
  "2013": [
    {
      "title": "Joint Modeling of Imaging and Genetics",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2013/2013_1_1_r-300x164.png"
    }
  ],
  "2012": [
    {
      "title": "Dominant Component Analysis of Electro-Physiological Connectivity Network",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2012/2012_1_1_r-300x146.png"
    },
    {
      ...
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2014/2014_4_1_r-300x106.png"
    },
    {
      "title": "Generative-Discriminative Basis Learning for Medical Imaging",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2012/2012_3_1-2-300x135.png"
    }
  ],
  "2011": [
    {
      "title": "Regularized Tensor Factorization for Multi-Modality Medical Image Classification",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2011/2011_1_1_r-300x136.png"
    },
    {
      "title": "Disease Classification and Prediction via Semi-Supervised Dimensionality Reduction",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2011/2011_2_1_r-300x228.png"
    }
  ],
  "2010": [
    {
      "title": "Prediction of MCI Conversion via MRI, CSF Biomarkers, and Pattern Classification",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2010/2010_1_1_r-300x220.png"
    },
    {
      "title": "Application of Trace-Norm and Low-Rank Matrix Decomposition for Computational Anatomy",
      "image_icon_link": "https://www.batman-lab.com/wp-content/uploads/2010/2010_2_1_r-300x189.png"
    }
  ]
}"""
...
# Download all images, mapping to the filenames used in HTML
pub_counter = 0
downloaded = 0
failed = 0
    ...
    for pub in data[year]:
        ...
        if img_url:
            ...
            if img_url.endswith('.jpg') or img_url.endswith('.jpeg'):
                img_filename = f"pub_{year}_{pub_counter}.jpg"
            else:
...
print(f"\n{'='*60}")
print(f"Summary: {downloaded} downloaded, {failed} failed, {pub_counter} total publications")
print(f"{'='*60}")
