...
# Full JSON from user's input - organized by year
# The HTML uses sequential numbering across all years
# So we need to flatten the JSON and number sequentially
